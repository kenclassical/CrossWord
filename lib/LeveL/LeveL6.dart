...
import 'package:crossword/LeveL/LeveL7.dart';
import 'package:crossword/main.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';

class MyLeveL6 extends StatefulWidget {
  const MyLeveL6({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<MyLeveL6> createState() => LeveL6();
}

class LeveL6 extends State<MyLeveL6> {
          ...
          RawMaterialButton(
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => MyLeveL7(title: '')));
            },
            child: Container(
              width: 198,
              height: 55,
