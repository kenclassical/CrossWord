...
import 'package:crossword/LeveL/LeveL8.dart';
import 'package:crossword/main.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';

class MyLeveL7 extends StatefulWidget {
  const MyLeveL7({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<MyLeveL7> createState() => LeveL7();
}

class LeveL7 extends State<MyLeveL7> {
          ...
          RawMaterialButton(
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => MyLeveL8(title: '')));
            },
            child: Container(
              width: 198,
              height: 55,
